            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7"  id="category_id"
                                    ...
                                    <option value="{{$project->category_id}}" selected>{{$project->category_name}}</option>
                                    {{-- @endforeach --}}
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="duration" value="{{$project->duration}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="budget" value="{{$project->budget}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="technologies" value="{{$project->technologies}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="url_website" value="{{$project->url_website}}" />
                    ...
                    <div id="youtube_url_div" class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="url_youtube" value="{{$project->url_youtube}}" />
                    ...
                    <div id="image_div" class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            >
                                {{-- style="background-image: url({{Storage::url('images/projects/'.$project->image->name ?? '')}})"> --}}
                                <div class="image-input-wrapper"></div>
                    ...
                    {{-- <div id="video_div" class="form-group row">
                        ...
                        <div class="col-3">
                            <div class="image-input image-input-empty image-input-outline" id="video"
                                style="background-image: url({{asset('controlPanel/assets/media/users/project.jpg')}})">
                                <div class="image-input-wrapper"></div>
...
$('#category_id').on('change',function(){
    ...
    function performUpdate(){
        ...
        axios.post('/cms/admin/projects/{{$project->id}}',formData)
