...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{__('cms.skills')}}</span>
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 150px">{{__('cms.degree')}}</th>
                        {{-- @can([ 'Update-Basic_skill']) --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$skill->title}}</span>
                           
                        </td>
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$skill->degree}}</span>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            {{-- @can([ 'Delete-Admin']) --}}
                            <a href="#" onclick="performDelete('{{$skill->id}}', this)"
...
<script>
      function performDelete(id, reference) {
        axios.delete('/cms/admin/skills/'+id)
