...
@section('page-name',__('cms.experiences'))
@section('main-page',__('cms.experiences'))
@section('sub-page',__('cms.experiences'))
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="date" class="form-control" id="start_date" value="{{$experience->start_date , date('Y-m-d')}}"
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="date" class="form-control" id="end_date" value="{{$experience->end_date ,date('Y-m-d')}}"
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="company_name" value="{{$experience->company_name}}"
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="description" value="{{$experience->description}}"
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performUpdate('{{$experience->id}}')"
...
<script>
     ...
     function performUpdate(id) {
        ...
        axios.post('/cms/admin/experiences/{{$experience->id}}',formData)
        .then(function (response) {
            console.log(response);
            toastr.success(response.data.message);
            window.location.href = '/cms/admin/experiences';
