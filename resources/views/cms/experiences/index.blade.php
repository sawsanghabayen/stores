...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{__('cms.experience')}}</span>
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$experience->start_date}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$experience->end_date}}</span>
                        </td>
             
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$experience->company_name}}</span>
                           
                        </td>
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$experience->description}}</span>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            <a href="#" onclick="performDelete('{{$experience->id}}', this)"
...
<script>
      function performDelete(id, reference) {
        axios.delete('/cms/admin/experiences/'+id)
