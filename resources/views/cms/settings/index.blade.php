            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        <th style="min-width: 120px">{{__('cms.background_image')}}</th>
                        <th style="min-width: 150px">{{__('cms.description_about_page')}}</th>
                        <th style="min-width: 150px">{{__('cms.description_portfolio_page')}}</th>
                        <th style="min-width: 150px">{{__('cms.description_contact_page')}}</th>
                        ...
                        <td class="pl-0 py-8">
                            ...
                            <div class="symbol symbol-50 symbol-light mr-4">
                                <span class="symbol-label">
                                    ...
                                    <img src="{{Storage::url($settings[0]->background_img ?? '')}}"
