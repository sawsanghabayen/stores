...
<body id="kt_body"
					...
					<div class="login-signin">
						...
						<form class="form" id="kt_login_signin_form">
							<input class="form-control h-auto form-control-solid py-4 px-8" hidden type="text"
								autocomplete="off" value="" id="token" />
							...
							<button type="button" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4"
								onclick="performForgotPassword()">Reset Password</button>
						</form>
					</div>
	...
	<script src="{{asset('controlPanel/assets/js/pages/custom/login/login-general.js?n=1')}}"></script>
	<!--end::Page Scripts-->
