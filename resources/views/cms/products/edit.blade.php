...
@section('page-name','Update product')
@section('main-page','Content Management')
@section('sub-page','markets')
@section('page-name-small','Update product')
            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7"  id="market_id"
                                    ...
                                    <option value="{{$market->id}}" @if( $product->market_id == $market->id) selected @endif >{{$market->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="discount_price" value="{{$product->discount_price}}" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @if($product->discount == 1) checked="checked" @endif  id="discount">
                                    <span></span>
                                </label>
                            </span>
                        </div>
